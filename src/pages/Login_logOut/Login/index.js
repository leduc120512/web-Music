            ...
            >
              <div className={cx("Login_inputs")}>
                ...
                <div className={cx("Login_actions")}>
                  <button type="button" className={cx("Login_quen")} onClick={() => setForgotOpen(true)}>
                    Quên mật khẩu?
                  </button>
                </div>
          ...
          <div className={cx("Forgot_main")}>
            ...
            <div className={cx("Forgot_content")}>
              ...
              <div className={cx("Forgot_actions")}>
                <button type="button" className={cx("Forgot_cancel")} onClick={() => setForgotOpen(false)}>
                  Hủy
                </button>
                <Button
                  type="button"
